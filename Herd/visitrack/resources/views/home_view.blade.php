...
<body>
    ...
    <section class="section1">
        <div class="desc1">
            <img src="css/img/building.png" alt="Lab building" class="building">
    ...
    <section class="section2">
        <div class="desc2">
            <img src="/resources/styles/img/city.png" alt="City drawing" class="city">
        ...
        <div class="desc3">
            <img src="/resources/styles/img/map.png" alt="Map drawing" class="map">
    ...
    <section class="section3">
        <div class="desc4">
            <img src="/resources/styles/img/college_students.png" alt="students drawing" class="students">
        ...
        <div class="desc5">
            <img src="/resources/styles/img/security.png" alt="security image" class="security">
